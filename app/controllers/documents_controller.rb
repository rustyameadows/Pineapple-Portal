class DocumentsController < ApplicationController
  ...
  def new
    ...
    inherit_reference_attributes(@document, @reference_document)
  ...
  def inherit_reference_attributes(document, reference_document)
    return unless reference_document

    document.source ||= reference_document.source
    document.client_visible = reference_document.client_visible if document.client_visible.nil?
    document.title ||= reference_document.title
  end
end
