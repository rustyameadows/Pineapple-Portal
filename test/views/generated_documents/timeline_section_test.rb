...
class TimelineSectionTest < ActionView::TestCase
  ...
  test "renders the timeline with the shared packet sheet header style" do
    ...
    assert_match(/\.generated-template--packet-sheet\s*\{[^}]*--generated-document-content-padding-x:\s*1in/m, rendered)
    assert_match(/\.generated-template--timeline\s*\{[^}]*--generated-document-content-padding-x:\s*1in/m, rendered)
