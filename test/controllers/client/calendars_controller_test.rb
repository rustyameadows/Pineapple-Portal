...
module Client
  class CalendarsControllerTest < ActionDispatch::IntegrationTest
    ...
    test "decision calendar groups decisions into monthly segments" do
      get client_event_calendar_path(@event.portal_slug, "decision-calendar")

      assert_response :success
      assert_select ".decision-calendar__segment-label", text: "September 2025", count: 1
    end

    test "decision calendar segment label ignores item time captions" do
      calendar_items(:decision_flowers).update!(time_caption: "Contracts Month")

      get client_event_calendar_path(@event.portal_slug, "decision-calendar")

      assert_response :success
      assert_select ".decision-calendar__segment-label", text: "Contracts Month", count: 0
      assert_select ".decision-calendar__segment-label", text: "September 2025", count: 1
    end
